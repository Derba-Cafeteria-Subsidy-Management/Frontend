          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <button
                ...
                className="w-full sm:w-auto border-2 border-gray-300 hover:border-[#1A5C3A] hover:text-[#1A5C3A] text-gray-700 px-8 py-3.5 rounded-[8px] font-semibold transition-all duration-200 flex items-center justify-center"
              >
                View Features
              </button>
            </div>
                  ...
                  <div className="mt-4 w-full">
                    {simStatus === 'idle' && (
                      <button
                        ...
                        className="bg-[#1A5C3A] hover:bg-[#15462c] text-white text-xs font-semibold px-4 py-2 rounded shadow-sm w-full transition-colors flex items-center justify-center gap-1.5"
                      >
                        <Fingerprint size={14} />
                        Simulate Scan
                      </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              <button
                ...
                className={`text-left p-5 rounded-lg border transition-all duration-200 flex items-start gap-4 ${selectedPreviewReport === 'payroll'
              ...
              <button
                ...
                className={`text-left p-5 rounded-lg border transition-all duration-200 flex items-start gap-4 ${selectedPreviewReport === 'subsidy'
                  ? 'bg-white border-[#1A5C3A] shadow-md'
                  : 'bg-transparent border-gray-200/80 hover:bg-gray-100/50'
                  }`}
              >
              ...
              <button
                ...
                className={`text-left p-5 rounded-lg border transition-all duration-200 flex items-start gap-4 ${selectedPreviewReport === 'invoice'
                  ? 'bg-white border-[#1A5C3A] shadow-md'
                  : 'bg-transparent border-gray-200/80 hover:bg-gray-100/50'
                  }`}
              >
            ...
            <div className="lg:col-span-8 bg-white border border-gray-200/80 rounded-xl p-6 shadow-sm flex flex-col justify-between min-h-[350px]">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                ...
                <button
                  ...
                  className="bg-[#1A5C3A] hover:bg-[#15462c] text-white text-xs font-semibold px-4 py-2 rounded transition-colors flex items-center gap-1.5"
                >
                  <FileText size={14} />
                  Download Sample
                </button>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="bg-[#1A5C3A] hover:bg-[#15462c] text-white text-xs font-semibold px-4 py-2.5 rounded shadow-sm transition-colors"
            >
